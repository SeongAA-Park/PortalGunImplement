...
#include "Portal/CustomPortalCopy.h"
...
// Sets default values
ACustomPortalCopy::ACustomPortalCopy()
{
	...
	// 이벤트 바인딩 (함수와 연결)
	DetectBoxCollision->OnComponentBeginOverlap.AddDynamic(this, &ACustomPortalCopy::OnOverlapBegin);
	DetectBoxCollision->OnComponentEndOverlap.AddDynamic(this, &ACustomPortalCopy::OnOverlapEnd);
...
void ACustomPortalCopy::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ACustomPortalCopy::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ACustomPortalCopy::UpdatePortalView()
{
...
void ACustomPortalCopy::OnOverlapBegin(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
}

void ACustomPortalCopy::OnOverlapEnd(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
